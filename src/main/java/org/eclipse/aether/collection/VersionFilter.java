 ...
 * @see org.eclipse.aether.RepositorySystem#collectDependencies(RepositorySystemSession,
 *      CollectRequest)
 */
public interface VersionFilter {
     ...
     * {@link Iterator#remove()} to delete unacceptable versions. If no versions remain after all filtering
