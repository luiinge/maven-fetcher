...
public final class ConflictResolver implements DependencyGraphTransformer {
    ...
    public static final class ConflictItem {
         ...
         *
         * @return A bit field consisting of {@link ConflictItem#OPTIONAL_FALSE} and/or
         *         {@link ConflictItem#OPTIONAL_TRUE} indicating the derived optionalities the
    ...
    public abstract static class VersionSelector {
         ...
         * {@link ConflictContext#setWinner(ConflictItem)} to deliver the winner. Failure to select a
